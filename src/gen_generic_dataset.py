...
save_dir =  cfg.generic_save_dir
prompts_dir = cfg.generic_prompts_dir
special_token = cfg.generic_special_token
pretrained_model_name_or_path = cfg.pretrained_model_name_or_path
img_per_prompt = cfg.img_per_prompt
img_size = cfg.img_size
content_flag = cfg.content_set
...
for prompt in tqdm(prompts):
    ...
    with open(prompt_file, "r") as p_file:
        prompt = p_file.read()
    if content_flag: # generate a content image from this style image.
